...
const contractABI = require("../artifacts/contracts/Bgeembeddings.sol/Bgeembeddings.json").abi;

program
    .name("bgeembeddings-cli")
    .description("CLI tool for Bgeembeddings smart contract")
    .version("1.0.0");
